...
WITH bills AS (
  ...
  WHERE
    ...
    AND ($4::"BillType" IS NULL OR bill."billType" = $4::"BillType")
    AND ($7::uuid IS NULL OR bill."userId" = $7::uuid)
    AND (
      $6::text IS NULL OR (
...
FROM bills
ORDER BY
  (CASE WHEN $8 = 'createdAt'  AND $9 = 'asc'  THEN bills."createdAt"  END) ASC,
  (CASE WHEN $8 = 'createdAt'  AND $9 = 'desc' THEN bills."createdAt"  END) DESC,
  (CASE WHEN $8 = 'totalAmount' AND $9 = 'asc'  THEN bills."totalAmount" END) ASC,
  (CASE WHEN $8 = 'totalAmount' AND $9 = 'desc' THEN bills."totalAmount" END) DESC,
  (CASE WHEN $8 = 'totalPaid'   AND $9 = 'asc'  THEN bills."totalPaid"   END) ASC,
  (CASE WHEN $8 = 'totalPaid'   AND $9 = 'desc' THEN bills."totalPaid"   END) DESC
LIMIT $1
OFFSET $2;
