...
import { Route as protectedBillingSuccessRouteImport } from './routes/(protected)/billing/success'
...
export interface FileRoutesById {
  ...
  '/(protected)/billing/success': typeof protectedBillingSuccessRoute
