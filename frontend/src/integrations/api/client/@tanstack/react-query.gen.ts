...
export const studentsControllerGetEnrolledStudentsQueryKey = (options: Options<StudentsControllerGetEnrolledStudentsData>) => createQueryKey('studentsControllerGetEnrolledStudents', options);
 ...
 */
export const studentsControllerGetEnrolledStudentsOptions = (options: Options<StudentsControllerGetEnrolledStudentsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await studentsControllerGetEnrolledStudents({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: studentsControllerGetEnrolledStudentsQueryKey(options)
    });
};
...
export const appointmentsControllerFindMentorAvailabilityQueryKey = (options: Options<AppointmentsControllerFindMentorAvailabilityData>) => createQueryKey('appointmentsControllerFindMentorAvailability', options);

export const appointmentsControllerFindMentorAvailabilityOptions = (options: Options<AppointmentsControllerFindMentorAvailabilityData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await appointmentsControllerFindMentorAvailability({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: appointmentsControllerFindMentorAvailabilityQueryKey(options)
    });
};

export const appointmentsControllerFindMentorAvailabilityInfiniteQueryKey = (options: Options<AppointmentsControllerFindMentorAvailabilityData>): QueryKey<Options<AppointmentsControllerFindMentorAvailabilityData>> => createQueryKey('appointmentsControllerFindMentorAvailability', options, true);

export const appointmentsControllerFindMentorAvailabilityInfiniteOptions = (options: Options<AppointmentsControllerFindMentorAvailabilityData>) => {
    return infiniteQueryOptions<AppointmentsControllerFindMentorAvailabilityResponse, DefaultError, InfiniteData<AppointmentsControllerFindMentorAvailabilityResponse>, QueryKey<Options<AppointmentsControllerFindMentorAvailabilityData>>, number | Pick<QueryKey<Options<AppointmentsControllerFindMentorAvailabilityData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<AppointmentsControllerFindMentorAvailabilityData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: appointmentsControllerFindMentorAvailabilityInfiniteQueryKey(options)
    });
};
...
export const enrollmentControllerExportActiveEnrollmentDataQueryKey = (options?: Options<EnrollmentControllerExportActiveEnrollmentDataData>) => createQueryKey('enrollmentControllerExportActiveEnrollmentData', options);
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerExportActiveEnrollmentDataOptions = (options?: Options<EnrollmentControllerExportActiveEnrollmentDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await enrollmentControllerExportActiveEnrollmentData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: enrollmentControllerExportActiveEnrollmentDataQueryKey(options)
    });
};

export const enrollmentControllerExportEnrollmentDataQueryKey = (options: Options<EnrollmentControllerExportEnrollmentDataData>) => createQueryKey('enrollmentControllerExportEnrollmentData', options);
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerExportEnrollmentDataOptions = (options: Options<EnrollmentControllerExportEnrollmentDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await enrollmentControllerExportEnrollmentData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: enrollmentControllerExportEnrollmentDataQueryKey(options)
    });
};
...
export const tasksControllerGetAllTasksForStudentQueryKey = (options?: Options<TasksControllerGetAllTasksForStudentData>) => createQueryKey('tasksControllerGetAllTasksForStudent', options);
 ...
 */
export const tasksControllerGetAllTasksForStudentOptions = (options?: Options<TasksControllerGetAllTasksForStudentData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await tasksControllerGetAllTasksForStudent({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: tasksControllerGetAllTasksForStudentQueryKey(options)
    });
};

export const tasksControllerGetAllTasksForStudentInfiniteQueryKey = (options?: Options<TasksControllerGetAllTasksForStudentData>): QueryKey<Options<TasksControllerGetAllTasksForStudentData>> => createQueryKey('tasksControllerGetAllTasksForStudent', options, true);

/**
 * Get all tasks across enrolled courses
 * Retrieves all assignments from enrolled courses in the current term with filtering and sorting options
 */
export const tasksControllerGetAllTasksForStudentInfiniteOptions = (options?: Options<TasksControllerGetAllTasksForStudentData>) => {
    return infiniteQueryOptions<TasksControllerGetAllTasksForStudentResponse, TasksControllerGetAllTasksForStudentError, InfiniteData<TasksControllerGetAllTasksForStudentResponse>, QueryKey<Options<TasksControllerGetAllTasksForStudentData>>, number | Pick<QueryKey<Options<TasksControllerGetAllTasksForStudentData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<TasksControllerGetAllTasksForStudentData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: tasksControllerGetAllTasksForStudentInfiniteQueryKey(options)
    });
};
