...
import {
  ...
  usersControllerUpdateUserDetails,
...
import type {
  ...
  UsersControllerUpdateUserDetailsData,
  UsersControllerUpdateUserDetailsError,
  UsersControllerUpdateUserDetailsResponse,
 ...
 * This operation updates the user details in the database
 */
export const usersControllerUpdateUserDetailsMutation = (
  options?: Partial<Options<UsersControllerUpdateUserDetailsData>>,
): UseMutationOptions<
  UsersControllerUpdateUserDetailsResponse,
  UsersControllerUpdateUserDetailsError,
  Options<UsersControllerUpdateUserDetailsData>
> => {
  const mutationOptions: UseMutationOptions<
    UsersControllerUpdateUserDetailsResponse,
    UsersControllerUpdateUserDetailsError,
