...
export const coursesControllerFindOneBySectionQueryKey = (options: Options<CoursesControllerFindOneBySectionData>) => createQueryKey('coursesControllerFindOneBySection', options);

/**
 * Retrieve a course by providing a course section id
 * Requires `ADMIN`, `STUDENT`, or `MENTOR` role.
 */
export const coursesControllerFindOneBySectionOptions = (options: Options<CoursesControllerFindOneBySectionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await coursesControllerFindOneBySection({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: coursesControllerFindOneBySectionQueryKey(options)
    });
};
