...
export const lmsControllerFindAllQueryKey = (options?: Options<LmsControllerFindAllData>) => createQueryKey('lmsControllerFindAll', options);

/**
 * Retrieve all modules
 * Retrieves a paginated list of modules based on the user role and provided filters.
 */
export const lmsControllerFindAllOptions = (options?: Options<LmsControllerFindAllData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await lmsControllerFindAll({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: lmsControllerFindAllQueryKey(options)
    });
};

export const lmsControllerFindAllInfiniteQueryKey = (options?: Options<LmsControllerFindAllData>): QueryKey<Options<LmsControllerFindAllData>> => createQueryKey('lmsControllerFindAll', options, true);

/**
 * Retrieve all modules
 * Retrieves a paginated list of modules based on the user role and provided filters.
 */
export const lmsControllerFindAllInfiniteOptions = (options?: Options<LmsControllerFindAllData>) => {
    return infiniteQueryOptions<LmsControllerFindAllResponse, LmsControllerFindAllError, InfiniteData<LmsControllerFindAllResponse>, QueryKey<Options<LmsControllerFindAllData>>, number | Pick<QueryKey<Options<LmsControllerFindAllData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<LmsControllerFindAllData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: lmsControllerFindAllInfiniteQueryKey(options)
    });
};
