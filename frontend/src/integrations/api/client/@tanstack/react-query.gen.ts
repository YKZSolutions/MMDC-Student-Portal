...
export const chatbotControllerPromptMutation = (options?: Partial<Options<ChatbotControllerPromptData>>): UseMutationOptions<unknown, ChatbotControllerPromptError, Options<ChatbotControllerPromptData>> => {
    const mutationOptions: UseMutationOptions<unknown, ChatbotControllerPromptError, Options<ChatbotControllerPromptData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await chatbotControllerPrompt({
                ...options,
                ...localOptions,
