...
export const coursesControllerFindBySectionQueryKey = (options: Options<CoursesControllerFindBySectionData>) => createQueryKey('coursesControllerFindBySection', options);

export const coursesControllerFindBySectionOptions = (options: Options<CoursesControllerFindBySectionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await coursesControllerFindBySection({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: coursesControllerFindBySectionQueryKey(options)
    });
};
