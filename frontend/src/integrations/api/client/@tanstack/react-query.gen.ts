 ...
 * Requires `ADMIN` role.
 */
export const coursesControllerRemoveMutation = (options?: Partial<Options<CoursesControllerRemoveData>>): UseMutationOptions<unknown, CoursesControllerRemoveError, Options<CoursesControllerRemoveData>> => {
    const mutationOptions: UseMutationOptions<unknown, CoursesControllerRemoveError, Options<CoursesControllerRemoveData>> = {
        mutationFn: async (localOptions) => {
