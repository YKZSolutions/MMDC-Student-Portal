...
import { type Options, usersControllerFindAll, usersControllerCreate, usersControllerRemove, usersControllerFindOne, usersControllerUpdate, coursesControllerFindAll, coursesControllerCreate, coursesControllerRemove, coursesControllerFindOne, coursesControllerUpdate, testControllerTestStudent, testControllerTestAdmin } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, type DefaultError } from '@tanstack/react-query';
import type { UsersControllerFindAllData, UsersControllerCreateData, UsersControllerCreateResponse, UsersControllerRemoveData, UsersControllerRemoveResponse, UsersControllerFindOneData, UsersControllerUpdateData, UsersControllerUpdateResponse, CoursesControllerFindAllData, CoursesControllerCreateData, CoursesControllerCreateResponse, CoursesControllerRemoveData, CoursesControllerRemoveResponse, CoursesControllerFindOneData, CoursesControllerUpdateData, CoursesControllerUpdateResponse, TestControllerTestStudentData, TestControllerTestAdminData } from '../types.gen';
...
export const usersControllerRemoveMutation = (options?: Partial<Options<UsersControllerRemoveData>>): UseMutationOptions<UsersControllerRemoveResponse, DefaultError, Options<UsersControllerRemoveData>> => {
    const mutationOptions: UseMutationOptions<UsersControllerRemoveResponse, DefaultError, Options<UsersControllerRemoveData>> = {
        mutationFn: async (localOptions) => {
