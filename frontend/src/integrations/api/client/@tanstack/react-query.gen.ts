...
export const yearLevelControllerFindAllQueryKey = (options?: Options<YearLevelControllerFindAllData>) => createQueryKey('yearLevelControllerFindAll', options);

export const yearLevelControllerFindAllOptions = (options?: Options<YearLevelControllerFindAllData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await yearLevelControllerFindAll({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: yearLevelControllerFindAllQueryKey(options)
    });
};

export const yearLevelControllerFindAllInfiniteQueryKey = (options?: Options<YearLevelControllerFindAllData>): QueryKey<Options<YearLevelControllerFindAllData>> => createQueryKey('yearLevelControllerFindAll', options, true);

export const yearLevelControllerFindAllInfiniteOptions = (options?: Options<YearLevelControllerFindAllData>) => {
    return infiniteQueryOptions<YearLevelControllerFindAllResponse, YearLevelControllerFindAllError, InfiniteData<YearLevelControllerFindAllResponse>, QueryKey<Options<YearLevelControllerFindAllData>>, number | Pick<QueryKey<Options<YearLevelControllerFindAllData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<YearLevelControllerFindAllData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: yearLevelControllerFindAllInfiniteQueryKey(options)
    });
};

export const yearLevelControllerCreateQueryKey = (options: Options<YearLevelControllerCreateData>) => createQueryKey('yearLevelControllerCreate', options);

export const yearLevelControllerCreateOptions = (options: Options<YearLevelControllerCreateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await yearLevelControllerCreate({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: yearLevelControllerCreateQueryKey(options)
    });
};

export const yearLevelControllerCreateMutation = (options?: Partial<Options<YearLevelControllerCreateData>>): UseMutationOptions<YearLevelControllerCreateResponse, YearLevelControllerCreateError, Options<YearLevelControllerCreateData>> => {
    const mutationOptions: UseMutationOptions<YearLevelControllerCreateResponse, YearLevelControllerCreateError, Options<YearLevelControllerCreateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await yearLevelControllerCreate({
                ...options,
                ...localOptions,
...
export const yearLevelControllerRemoveMutation = (options?: Partial<Options<YearLevelControllerRemoveData>>): UseMutationOptions<YearLevelControllerRemoveResponse, YearLevelControllerRemoveError, Options<YearLevelControllerRemoveData>> => {
    const mutationOptions: UseMutationOptions<YearLevelControllerRemoveResponse, YearLevelControllerRemoveError, Options<YearLevelControllerRemoveData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await yearLevelControllerRemove({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const yearLevelControllerFindOneQueryKey = (options: Options<YearLevelControllerFindOneData>) => createQueryKey('yearLevelControllerFindOne', options);

export const yearLevelControllerFindOneOptions = (options: Options<YearLevelControllerFindOneData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await yearLevelControllerFindOne({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: yearLevelControllerFindOneQueryKey(options)
    });
};

export const yearLevelControllerUpdateMutation = (options?: Partial<Options<YearLevelControllerUpdateData>>): UseMutationOptions<YearLevelControllerUpdateResponse, YearLevelControllerUpdateError, Options<YearLevelControllerUpdateData>> => {
    const mutationOptions: UseMutationOptions<YearLevelControllerUpdateResponse, YearLevelControllerUpdateError, Options<YearLevelControllerUpdateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await yearLevelControllerUpdate({
                ...options,
                ...localOptions,
                throwOnError: true
            });
