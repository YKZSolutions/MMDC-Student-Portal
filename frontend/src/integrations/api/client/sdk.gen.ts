...
export const yearLevelControllerFindAll = <ThrowOnError extends boolean = false>(options?: Options<YearLevelControllerFindAllData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<YearLevelControllerFindAllResponses, YearLevelControllerFindAllErrors, ThrowOnError>({
        url: '/year-levels',
        ...options
    });
};

export const yearLevelControllerCreate = <ThrowOnError extends boolean = false>(options: Options<YearLevelControllerCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<YearLevelControllerCreateResponses, YearLevelControllerCreateErrors, ThrowOnError>({
        url: '/year-levels',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const yearLevelControllerRemove = <ThrowOnError extends boolean = false>(options: Options<YearLevelControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<YearLevelControllerRemoveResponses, YearLevelControllerRemoveErrors, ThrowOnError>({
        url: '/year-levels/{id}',
        ...options
    });
};

export const yearLevelControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<YearLevelControllerFindOneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<YearLevelControllerFindOneResponses, YearLevelControllerFindOneErrors, ThrowOnError>({
        url: '/year-levels/{id}',
        ...options
    });
};

export const yearLevelControllerUpdate = <ThrowOnError extends boolean = false>(options: Options<YearLevelControllerUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<YearLevelControllerUpdateResponses, YearLevelControllerUpdateErrors, ThrowOnError>({
        url: '/year-levels/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
