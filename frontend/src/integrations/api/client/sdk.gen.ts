...
import type { UsersControllerFindAllData, UsersControllerFindAllResponses, UsersControllerFindAllErrors, UsersControllerCreateData, UsersControllerCreateResponses, UsersControllerCreateErrors, UsersControllerInviteUserData, UsersControllerInviteUserResponses, UsersControllerInviteUserErrors, UsersControllerUpdateOwnUserDetailsData, UsersControllerUpdateOwnUserDetailsResponses, UsersControllerUpdateOwnUserDetailsErrors, UsersControllerFindOneData, UsersControllerFindOneResponses, UsersControllerFindOneErrors, UsersControllerUpdateUserDetailsData, UsersControllerUpdateUserDetailsResponses, UsersControllerUpdateUserDetailsErrors, UsersControllerUpdateUserStatusData, UsersControllerUpdateUserStatusResponses, UsersControllerUpdateUserStatusErrors, CoursesControllerFindAllData, CoursesControllerFindAllResponses, CoursesControllerCreateData, CoursesControllerCreateResponses, CoursesControllerRemoveData, CoursesControllerRemoveResponses, CoursesControllerFindOneData, CoursesControllerFindOneResponses, CoursesControllerUpdateData, CoursesControllerUpdateResponses, TestControllerTestStudentData, TestControllerTestStudentResponses, TestControllerTestAdminData, TestControllerTestAdminResponses, AuthControllerGetMetadataData, AuthControllerGetMetadataResponses, AuthControllerGetMetadataErrors } from './types.gen';
 ...
 * This operation updates the user details in the database
 */
export const usersControllerUpdateUserDetails = <ThrowOnError extends boolean = false>(options: Options<UsersControllerUpdateUserDetailsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UsersControllerUpdateUserDetailsResponses, UsersControllerUpdateUserDetailsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
