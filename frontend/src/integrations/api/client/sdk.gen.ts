 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerCreateCourseOffering = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerCreateCourseOfferingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<EnrollmentControllerCreateCourseOfferingResponses, EnrollmentControllerCreateCourseOfferingErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerCreateCourseSection = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerCreateCourseSectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<EnrollmentControllerCreateCourseSectionResponses, EnrollmentControllerCreateCourseSectionErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerFindAllCourseOfferings = <ThrowOnError extends boolean = false>(options?: Options<EnrollmentControllerFindAllCourseOfferingsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<EnrollmentControllerFindAllCourseOfferingsResponses, EnrollmentControllerFindAllCourseOfferingsErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerFindAllCourseSections = <ThrowOnError extends boolean = false>(options?: Options<EnrollmentControllerFindAllCourseSectionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<EnrollmentControllerFindAllCourseSectionsResponses, EnrollmentControllerFindAllCourseSectionsErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerFindOneCourseOffering = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerFindOneCourseOfferingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<EnrollmentControllerFindOneCourseOfferingResponses, EnrollmentControllerFindOneCourseOfferingErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerRemoveCourseSection = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerRemoveCourseSectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<EnrollmentControllerRemoveCourseSectionResponses, EnrollmentControllerRemoveCourseSectionErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerFindOneCourseSection = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerFindOneCourseSectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<EnrollmentControllerFindOneCourseSectionResponses, EnrollmentControllerFindOneCourseSectionErrors, ThrowOnError>({
        url: '/enrollment/offerings/{offeringId}/sections/{sectionId}',
        ...options
    });
};
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerUpdateCourseSection = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerUpdateCourseSectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<EnrollmentControllerUpdateCourseSectionResponses, EnrollmentControllerUpdateCourseSectionErrors, ThrowOnError>({
        url: '/enrollment/offerings/{offeringId}/sections/{sectionId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerRemoveCourseOffering = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerRemoveCourseOfferingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<EnrollmentControllerRemoveCourseOfferingResponses, EnrollmentControllerRemoveCourseOfferingErrors, ThrowOnError>({
