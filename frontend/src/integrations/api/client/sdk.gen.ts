 ...
 */
export const studentsControllerGetEnrolledStudents = <ThrowOnError extends boolean = false>(options: Options<StudentsControllerGetEnrolledStudentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StudentsControllerGetEnrolledStudentsResponses, StudentsControllerGetEnrolledStudentsErrors, ThrowOnError>({
...
export const appointmentsControllerFindMentorAvailability = <ThrowOnError extends boolean = false>(options: Options<AppointmentsControllerFindMentorAvailabilityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AppointmentsControllerFindMentorAvailabilityResponses, unknown, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerExportActiveEnrollmentData = <ThrowOnError extends boolean = false>(options?: Options<EnrollmentControllerExportActiveEnrollmentDataData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<EnrollmentControllerExportActiveEnrollmentDataResponses, EnrollmentControllerExportActiveEnrollmentDataErrors, ThrowOnError>({
 ...
 * Requires `ADMIN` role.
 */
export const enrollmentControllerExportEnrollmentData = <ThrowOnError extends boolean = false>(options: Options<EnrollmentControllerExportEnrollmentDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<EnrollmentControllerExportEnrollmentDataResponses, EnrollmentControllerExportEnrollmentDataErrors, ThrowOnError>({
...
/**
 * Get all tasks across enrolled courses
 * Retrieves all assignments from enrolled courses in the current term with filtering and sorting options
 */
export const tasksControllerGetAllTasksForStudent = <ThrowOnError extends boolean = false>(options?: Options<TasksControllerGetAllTasksForStudentData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TasksControllerGetAllTasksForStudentResponses, TasksControllerGetAllTasksForStudentErrors, ThrowOnError>({
        url: '/tasks',
        ...options
    });
};
