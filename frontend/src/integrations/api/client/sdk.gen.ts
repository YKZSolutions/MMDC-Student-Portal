 ...
 */
export const coursesControllerFindOneBySection = <ThrowOnError extends boolean = false>(options: Options<CoursesControllerFindOneBySectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CoursesControllerFindOneBySectionResponses, CoursesControllerFindOneBySectionErrors, ThrowOnError>({
 ...
 */
export const lmsControllerFindAll = <ThrowOnError extends boolean = false>(options?: Options<LmsControllerFindAllData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<LmsControllerFindAllResponses, LmsControllerFindAllErrors, ThrowOnError>({
        url: '/lms',
        ...options
    });
};
