...
export const lmsAssignmentControllerUpdate = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<LmsAssignmentControllerUpdateResponses, LmsAssignmentControllerUpdateErrors, ThrowOnError>({
...
export const lmsAssignmentControllerSubmit = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerSubmitData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<LmsAssignmentControllerSubmitResponses, LmsAssignmentControllerSubmitErrors, ThrowOnError>({
        url: '/modules/{moduleId}/assignments/{assignmentId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const lmsAssignmentControllerFindAllForAdmin = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerFindAllForAdminData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LmsAssignmentControllerFindAllForAdminResponses, LmsAssignmentControllerFindAllForAdminErrors, ThrowOnError>({
        url: '/modules/{moduleId}/assignments',
        ...options
    });
};

export const lmsAssignmentControllerFindAllForMentor = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerFindAllForMentorData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LmsAssignmentControllerFindAllForMentorResponses, LmsAssignmentControllerFindAllForMentorErrors, ThrowOnError>({
        url: '/modules/{moduleId}/assignments/mentor',
        ...options
    });
};

export const lmsAssignmentControllerFindAllForStudent = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerFindAllForStudentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LmsAssignmentControllerFindAllForStudentResponses, LmsAssignmentControllerFindAllForStudentErrors, ThrowOnError>({
        url: '/modules/{moduleId}/assignments/student',
        ...options
    });
};

export const lmsAssignmentControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerFindOneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LmsAssignmentControllerFindOneResponses, LmsAssignmentControllerFindOneErrors, ThrowOnError>({
        url: '/modules/{moduleId}/assignments/{moduleContentId}',
        ...options
    });
};

export const lmsAssignmentControllerFindOneForStudent = <ThrowOnError extends boolean = false>(options: Options<LmsAssignmentControllerFindOneForStudentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LmsAssignmentControllerFindOneForStudentResponses, LmsAssignmentControllerFindOneForStudentErrors, ThrowOnError>({
        url: '/modules/{moduleId}/assignments/{moduleContentId}/student',
        ...options
    });
};

export const lmsSubmissionControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<LmsSubmissionControllerFindOneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<LmsSubmissionControllerFindOneResponses, LmsSubmissionControllerFindOneErrors, ThrowOnError>({
        url: '/modules/{moduleId}/submissions/{submissionId}',
        ...options
    });
};

export const lmsSubmissionControllerGrade = <ThrowOnError extends boolean = false>(options: Options<LmsSubmissionControllerGradeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<LmsSubmissionControllerGradeResponses, LmsSubmissionControllerGradeErrors, ThrowOnError>({
        url: '/modules/{moduleId}/submissions/{submissionId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const transcriptControllerFindAll = <ThrowOnError extends boolean = false>(options?: Options<TranscriptControllerFindAllData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TranscriptControllerFindAllResponses, unknown, ThrowOnError>({
        url: '/transcript',
        ...options
    });
};

export const transcriptControllerCreate = <ThrowOnError extends boolean = false>(options: Options<TranscriptControllerCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TranscriptControllerCreateResponses, unknown, ThrowOnError>({
        url: '/transcript',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const transcriptControllerRemove = <ThrowOnError extends boolean = false>(options: Options<TranscriptControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<TranscriptControllerRemoveResponses, unknown, ThrowOnError>({
        url: '/transcript/{id}',
        ...options
    });
};

export const transcriptControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<TranscriptControllerFindOneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TranscriptControllerFindOneResponses, unknown, ThrowOnError>({
        url: '/transcript/{id}',
        ...options
    });
};
...
export const transcriptControllerUpdate = <ThrowOnError extends boolean = false>(options: Options<TranscriptControllerUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<TranscriptControllerUpdateResponses, unknown, ThrowOnError>({
        url: '/transcript/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
