...
export const coursesControllerFindBySection = <ThrowOnError extends boolean = false>(options: Options<CoursesControllerFindBySectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CoursesControllerFindBySectionResponses, CoursesControllerFindBySectionErrors, ThrowOnError>({
